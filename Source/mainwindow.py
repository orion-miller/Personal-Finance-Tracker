...
class Ui_OrionsApp(object):
    def setupUi(self, OrionsApp):
        ...
        self.graphIE3_2 = PlotWidget(self.tab)
        self.graphIE3_2.setObjectName(u"graphIE3_2")
        self.graphIE3_2.setGeometry(QRect(660, 10, 451, 691))
        ...
        self.tableView.setGeometry(QRect(0, 30, 411, 431))
        self.pushButton_addcol = QPushButton(self.tab_3)
        self.pushButton_addcol.setObjectName(u"pushButton_addcol")
        self.pushButton_addcol.setGeometry(QRect(240, 0, 79, 24))
