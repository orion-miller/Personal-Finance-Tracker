...
# application icon
icon = C:\Users\orion\AppData\Local\Programs\Python\Python310\Lib\site-packages\PySide6\scripts\deploy_lib\pyside_icon.ico
...
modules = Core,Gui,UiTools,Widgets
